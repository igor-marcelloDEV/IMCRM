...
- [GitHub Security Advisories](https://github.com/igor-marcelloDEV/IMCRM/security/advisories/new)
...
In scope:
- Anything in this repository (`igor-marcelloDEV/IMCRM`), including webhook and auth
