 ...
 * customer taps them on their own device). Shares the `Interactive`
 * i18n namespace with interactive-builder.tsx.
 */
    ...
    >
      <div className="px-3 py-2">
        ...
        <p className="whitespace-pre-wrap break-words text-sm">
          {payload.body || (
            <span className="text-muted-foreground">{t("messageBodyPlaceholder")}</span>
          )}
        </p>
        {payload.footer ? (
