...
const navItems: NavItem[] = [
  ...
  { href: "/execution", labelKey: "execution", icon: CalendarCheck2 },
  { href: "/operacao", labelKey: "operations", icon: Compass },
  { href: "/inbox", labelKey: "inbox", icon: MessageSquare },
  { href: "/notifications", labelKey: "notifications", icon: Bell },
  { href: "/contacts", labelKey: "contacts", icon: Users },
  { href: "/pipelines", labelKey: "pipelines", icon: GitBranch },
  { href: "/orders", labelKey: "orders", icon: Package },
  { href: "/fulfillment", labelKey: "deliveries", icon: Truck },
  { href: "/kitchen", labelKey: "kitchen", icon: ChefHat },
  { href: "/ready", labelKey: "ready", icon: PackageCheck },
  { href: "/drivers", labelKey: "drivers", icon: UsersRound },
  { href: "/catalog", labelKey: "catalog", icon: BookOpen },
