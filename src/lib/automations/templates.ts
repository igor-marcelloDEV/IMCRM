...
export const AUTOMATION_TEMPLATES: Record<TemplateSlug, AutomationTemplateDefinition> = {
    ...
    steps: [
      {
        ...
        step_config: {
          text: "Olá! 👋 Obrigado por entrar em contato. Já já respondemos você.",
        },
      },
      {
        step_type: 'add_tag',
  ...
  out_of_office: {
    ...
    description: 'Resposta automática fora do horário de atendimento, para ninguém ficar esperando.',
    ...
    steps: [
      {
        ...
        step_config: {
          text:
            "Ótimo — vou te ajudar com os preços! Uma pergunta rápida: mais ou menos quantos usuários você está buscando?",
        },
      },
      {
        step_type: 'wait',
  ...
  follow_up_reminder: {
    ...
    description: 'Envia um lembrete se um contato não respondeu em 24 horas.',
    trigger_type: 'new_message_received',
    trigger_config: {},
    steps: [
      {
      ...
      },
      {
        ...
        step_config: {
          text:
            "Só retomando o contato — você ainda tem alguma dúvida? Estou à disposição para ajudar!",
        },
      },
    ],
  },
