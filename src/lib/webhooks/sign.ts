...
//
// Every delivery carries an `X-Imcrm-Signature` header so receivers
// can verify the request really came from imcrm and wasn't tampered
// with or replayed. The scheme is Stripe-style:
//
//   X-Imcrm-Signature: t=<unix_seconds>,v1=<hex HMAC-SHA256>
//
...
/**
 * Build the `X-Imcrm-Signature` header value for `rawBody`, signed
...
/**
 * Verify a signature header. Exposed so an imcrm-to-imcrm integration
