...
//
// Why the `imcrm_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     an imcrm key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for a `imcrm_test_` variant if
...
export const API_KEY_PREFIX = 'imcrm_live_';
