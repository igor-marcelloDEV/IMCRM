...
```bash
# 1. Fork on GitHub: https://github.com/igor-marcelloDEV/IMCRM → Fork
# 2. Clone your fork
git clone https://github.com/<your-username>/IMCRM.git
cd IMCRM
...
```bash
git remote add upstream https://github.com/igor-marcelloDEV/IMCRM.git  # once
git fetch upstream
git checkout main
...
[bug report](https://github.com/igor-marcelloDEV/IMCRM/issues/new?template=bug_report.yml)
...
- Rebrand. The "IMCRM" name, favicon, and domain belong to this
  project; please swap them for your own before putting your
